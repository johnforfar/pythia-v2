...
const Hero = () => {
  return (
    <>
      <section
        id='home'
        className='bg-white px-[30px] pb-[36px]  pt-[36px] text-[#000000] md:px-[70px] md:pb-[43px] md:pt-[43px]  lg:px-[105px] lg:pb-[50px] lg:pt-[50px] xl:px-[120px] xl:pb-[58px] xl:pt-[58px] 2xl:px-[150px] 2xl:pb-[73px] 2xl:pt-[73px]'
      >
