...
const Footer = () => {
  ...
  return (
    <>
      <section
        id='home'
        className='bg-white px-[30px] pb-[57px]  pt-[36px] text-[#000000] md:px-[70px] md:pb-[68px] md:pt-[43px]  lg:px-[157px] lg:pb-[80px] lg:pt-[50px] xl:px-[180px] xl:pb-[91px] xl:pt-[58px] 2xl:px-[225px] 2xl:pb-[114px] 2xl:pt-[73px]'
      >
        <div className='justify-center  md:flex md:gap-x-[30px] lg:gap-x-[157px] xl:gap-x-[180px] 2xl:gap-x-[225px]'>
          ...
          <div className='gap-x-[20px] text-[9px] font-normal text-[#959595] md:flex md:gap-x-[24px] md:text-[10px] lg:gap-x-[28px] lg:text-[11px] lg:!leading-[150%] xl:gap-x-[32px] xl:text-[13px] 2xl:gap-x-[40px] 2xl:text-[16px]'>
            <div className='mt-[26px] border-t-[1px] border-[#D9D9D9] pb-[8px] pt-[4px] md:mt-[0px] lg:pb-[12px] lg:pt-[12px] 2xl:pb-[15px] 2xl:pt-[15px] '>
            ...
            <div className='mt-[16px] text-[8px] md:mt-[0px]  md:max-w-[220px] md:text-[10px] lg:text-[12px]  xl:text-[13px] 2xl:text-[16px]'>
              <div className='border-b-[1px] border-t-[1px] border-[#D9D9D9] pb-[8px]  pt-[4px] text-[#000] lg:pb-[12px] lg:pt-[12px]  2xl:pb-[15px] 2xl:pt-[15px] '>
